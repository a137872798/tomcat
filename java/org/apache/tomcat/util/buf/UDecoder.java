...
public final class UDecoder {
     ...
     * URLDecode, will modify the source
     *
     * @param mb    The URL encoded String, bytes or chars  未解码前的字符串
     * @param query <code>true</code> if this is a query string   代表本url 是否是 查询参数 也就是 ?k1=v1&k2=v2
     * @throws IOException Invalid %xx URL encoding
     */
