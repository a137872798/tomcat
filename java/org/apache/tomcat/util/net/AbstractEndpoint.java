 ...
 * endpoint 代表一个端点对象 (绑定在哪个ip，监听了哪个端口)
 */
public abstract class AbstractEndpoint<S> {
     ...
     * 该对象内部存了一堆使用共享锁的对象 先不细看
     */
    private volatile LimitLatch connectionLimitLatch = null;

    /**
     * Socket properties   该对象可以对 socket serversocket  socketchannel 等进行属性设置
     */
